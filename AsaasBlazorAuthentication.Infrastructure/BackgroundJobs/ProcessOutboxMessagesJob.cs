...
namespace AsaasBlazorAuthentication.Infrastructure.BackgroundJobs;
...
internal sealed class ProcessOutboxMessagesJob : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var context = scope.ServiceProvider.GetRequiredService<AsaasBlazorAuthenticationDbContext>();
